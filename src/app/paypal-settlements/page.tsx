...
// Mock data for V1.5 - only PayPal claims
const MOCK_CLAIMS = [
  {
    id: "1",
...
export default function PayPalSettlementsPage() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-4 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 mt-1">
              Get paid faster with PayPal - no waiting for checks in the mail.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-white rounded-lg shadow p-4 text-center">
          ...
          <div className="text-sm text-gray-500">PayPal Claims</div>
        </div>
        <div className="bg-white rounded-lg shadow p-4 text-center">
        ...
        <div className="bg-white rounded-lg shadow p-4 text-center">
          ...
          <div className="text-sm text-gray-500">PayPal Speed</div>
        </div>
      </div>
